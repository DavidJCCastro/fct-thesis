...
\begin{figure}[htbp]
  ...
  \caption[Diagram of New Method of Information Extraction]{In the new method of information extraction the mapping between a UniProt ID and a PDB ID is downloaded from EBI's website. Thanks to this, all we have to do is fetch the primary citation information for each PDB entry and fetch the paper full-text from EuropePMC.}
  \label{fig:new_viz}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Selected Papers Full-Text Extraction Results Sankey Diagram}
