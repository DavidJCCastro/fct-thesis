...
Having this simplified mapping allowed us to create better visualizations of the data, such as the distribution of PDB and UniProt IDs that we see in fig.~\ref{fig:mapping_distribution}.
